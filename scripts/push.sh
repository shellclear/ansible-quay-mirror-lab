...
for tag in latest dev ; \
    do podman tag \
        registry.access.redhat.com/ubi9/ubi-minimal:latest \
        registry01-quay314.lab.localdomain:8885/source_organization/private_repo01:$tag && \
        podman tag \
        registry.access.redhat.com/ubi9/ubi-minimal:latest \
        registry01-quay314.lab.localdomain:8885/source_organization/public_repo01:$tag ; \
done
